...
class AlarmSettingsTableVC: UITableViewController {
    ...
    @IBAction func repeatSwitchValueChanged(_ sender: Any) {
        ...
        if repeatSwitch.isOn {
            toast.message = "Trigger will stay active after ringing"
        }
        else {
    ...
    func showAlarmLabelAlert() {
        let alert = UIAlertController(title: "Trigger Label", message: "", preferredStyle: .alert)
        alert.addTextField { (textField) in
            textField.text = self.alarmLabel
            textField.placeholder = "Trigger Label"
        }
    ...
    func showSoundPickerInAlert() {
        let alert = UIAlertController(title: "Select Trigger Sound", message: "", preferredStyle: .actionSheet)
